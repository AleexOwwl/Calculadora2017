...
class CalculadoraTest(unittest.TestCase):
	...
	def test_sumar_10001_mas_5_igual_NoSeAceptanNumerosMayoresA10000(self):
		self.assertEquals(self.calc.suma(10001, 5), 'No se aceptan numeros mayores a 10,000')
	...
	def test_restar_10001_menos_5_igual_NoSeAceptanNumerosMayoresA10000(self):
		self.assertEquals(self.calc.resta(10001, 5), 'No se aceptan numeros mayores a 10,000')
